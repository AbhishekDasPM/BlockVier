...
/** @dev CHANGES MADE WITH RESPECT TO MARKETV1.SOL: changed the postions of following 
to top due to Reentrancy warning by Slither.......
Reentrancy in Market.acceptBidNonLazyNFT(IERC721,uint256) (contracts/MarketV1.sol#461-544):
        External calls:
        - success1 = IERC20(erc20Token).transfer(seller,amount) (contracts/MarketV1.sol#505)
        - _transferAsset(_nftContract,_tokenId) (contracts/MarketV1.sol#514)
                - _nft.transferFrom(seller,highestBidder,_tokenId) (contracts/MarketV1.sol#555)
        State variables written after the call(s):
        - revokeMarketItem(_tokenId) (contracts/MarketV1.sol#518)

        -----------------------------------------------------------------------------------------------------------------
   State variables written after the call(s):
        - tokenIdToMarketItem[_tokenId].bidders.push(msg.sender) (contracts/MarketV1.sol#449)
        - tokenIdToMarketItem[_tokenId].highestBid = _newBidinERC20 (contracts/MarketV1.sol#451)
        - tokenIdToMarketItem[_tokenId].isBidActive = true (contracts/MarketV1.sol#457)
Reentrancy in LazyNFT.nonLazyMint(address,string) (contracts/LazyNFT.sol#111-148):

------------------------------------------------------------------------------------------------------------------------

Reentrancy in LazyNFT.nonLazyMint(address,string) (contracts/LazyNFT.sol#111-148):
        External calls:
        - _safeMint(to,newTokenId) (contracts/LazyNFT.sol#126)
        ...
        State variables written after the call(s):
        - _transfer(to,to,newTokenId) (contracts/LazyNFT.sol#143)
                - _balances[from] -= 1 (node_modules/@openzeppelin/contracts/token/ERC721/ERC721.sol#343)
                - _balances[to] += 1 (node_modules/@openzeppelin/contracts/token/ERC721/ERC721.sol#344)
        - _transfer(to,to,newTokenId) (contracts/LazyNFT.sol#143)
                - _owners[tokenId] = to (node_modules/@openzeppelin/contracts/token/ERC721/ERC721.sol#345)
